...
Then activate your virtual environment of choice:

`conda activate envname` (if using Conda)
...
Or if you want to modify code in your local repository have it be tracked by the installed package:
